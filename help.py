...
<table width="600" cellspacing="0" cellpadding="5px" border="0x" bgcolor="#000000" align="center">
    <thead>
        <tr>
            ...
            <p><a title="MIDI Sight Reader - Click To Launch Java Applet - Requires jdk-1.6" href="http://dev.asymptopia.org/static/sightreadingtrainer/MFC.html"> 	<img width="620" height="361" alt="" src="http://dev.asymptopia.org/static/sightreadingtrainer/img/MIDI_SightReader_3.3b.png" /></a></p>
    ...
    <tbody>
        <tr>
            ...
            <p style="text-align: justify;"><span style="font-family: Comic Sans MS;">1. Use with real piano/guitar ... same way as <a href="http://dev.asymptopia.org/download">original</a> MidiFlashCard&nbsp;System<br />
            </span></p>
